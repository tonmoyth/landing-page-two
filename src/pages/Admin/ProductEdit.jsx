...
export default function ProductEdit() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      try {
        ...
        if (status === 400) msg = serverMsg || "Invalid request.";
        if (status === 404) msg = "Product not found.";
        if (status === 500) msg = "Server error. Please try later.";
  ...
  return (
    <main className="flex-1 p-6  from-blue-50 to-indigo-50 min-h-[calc(100vh-65px)] flex items-center justify-center">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl p-8 flex flex-col items-center">
        ...
        <p className="text-gray-500 mb-6 text-center">
          Edit product picture and two icons.
        </p>
